...
document.addEventListener("DOMContentLoaded", () => {
    document.addEventListener("mousedown", e => {
        ...
        const onMouseMove = e => {
            ...
            storage = document.elementFromPoint(e.clientX, e.clientY)?.closest(".storage");
        ...
        const onMouseUp = () => {
            ...
            totalPrice.textContent = parseFloat(totalPrice.textContent) + parseFloat(itemPrice.textContent);
        };
